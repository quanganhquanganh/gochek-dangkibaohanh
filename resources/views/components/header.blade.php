<div class="w-full bg-background">
    <div class="w-full lg:w-[960px] mx-auto  flex justify-center lg:justify-start items-center text-white p-2 md:p-4">
        <a class="" href="{{ route('home') }}">
            <img src="{{ asset('logo.png') }}" class="w-[120px] mx-auto hidden lg:block">
        ...
        <div class="flex flex-col text-[8px] md:text-base gap-0 lg:gap-2">
            ...
            <div class="flex items-center">
                ...
                <span class="ml-2">037 235 4208 (TikTok, Shopee, Lazada)</span>
            </div>
            <div class="flex items-center">
                <div class="hidden md:block">
                    @include('components.icon.phone', ['fill' => '#fff'])
