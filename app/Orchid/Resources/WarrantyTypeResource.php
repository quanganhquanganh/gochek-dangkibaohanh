...
class WarrantyTypeResource extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\WarrantyType::class;
    ...
    public function rules(\Illuminate\Database\Eloquent\Model $model): array
    {
        return [
            'code' => [
                'required',
                'max:10',
                Rule::unique('warranty_types', 'code')->ignore($model->id),
            ],
        ];
    }
